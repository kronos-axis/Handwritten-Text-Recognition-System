...
class Model:
    ...
    def setupCNN(self):
        ...
        kernelVals = [5, 5, 5, 5, 5, 3, 3, 3]
        featureVals = [1, 32, 64, 128, 128, 256, 512, 1024]
    ...
    def setupCTC(self):
        ...
        if self.decoderType == DecoderType.BestPath:
            ...
            wordChars = open('C:/Users/rishu/Desktop/new htr/model/wordCharList.txt').read().splitlines()[0]
            corpus = open('C:/Users/rishu/Desktop/new htr/data/corpus.txt').read()
    ...
    def setupTF(self):
        ...
        modelDir = 'C:/Users/rishu/Desktop/new htr/model/'
    ...
    def dumpNNOutput(self, rnnOutput):
        ...
        dumpDir = 'C:/Users/rishu/Desktop/dump/'
    ...
    def save(self):
        "save model to file"
        self.snapID += 1
        self.saver.save(self.sess, 'C:/Users/rishu/Desktop/new htr/model/snapshot', global_step=self.snapID)
